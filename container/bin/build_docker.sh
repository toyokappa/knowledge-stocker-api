...
export APP_NAME=wakatter
export EB_BUCKET=elasticbeanstalk-ap-northeast-1-556702383400
export NAMESPACE=toyokappa
export CONTAINER_REGISTRY=556702383400.dkr.ecr.ap-northeast-1.amazonaws.com
export SHA1=$1
export ENV=$2
